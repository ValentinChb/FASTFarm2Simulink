...
% Override output port properties
block.OutputPort(2).Dimensions  = [3 84];
block.OutputPort(2).DatatypeID  = 1; %'single' matrix
block.OutputPort(2).Complexity  = 'Real';

% Override output port properties
block.OutputPort(3).Dimensions  = 1;
block.OutputPort(3).DatatypeID  = 8; %bolean
...
block.OutputPort(1).Data = iT;
block.OutputPort(2).Data = avrSWAP;
block.OutputPort(3).Data = incomplete;
