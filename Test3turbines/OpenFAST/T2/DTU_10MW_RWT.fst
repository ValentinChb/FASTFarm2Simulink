...
FAST model of the DTU 10MW Reference Wind Turbine on monopile
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
330	TMax            - Total run time (s)
...
"DTU_10MW_RWT_AeroDynv15.dat"  	AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"DTU_10MW_RWT_ServoDyn.dat"     ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
